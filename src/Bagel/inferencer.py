...
class InterleaveInferencer:
    ...
    def interleave_inference(
        ...
        with torch.autocast(device_type="cuda", enabled=True, dtype=torch.bfloat16):
            ...
            if understanding_output:
                ...
                if think:
                    gen_text,text_hidden_states = self.gen_text(gen_context, do_sample=do_sample, temperature=text_temperature, max_length=max_think_token_n)
                    print(gen_text)
        ...
        return output_list, text_hidden_states
    ...
    def __call__(
        ...
        **kargs
        ...
        output_list,text_hidden_states = self.interleave_inference(input_list, **kargs)
        ...
        return output_dict,text_hidden_states
