...
# ==================== 配置路径 ====================
BASE_ROOT="/media/raid/workspace/miyapeng/Multimodal-LatentSeek/src/geneval_results/long_results"
STEPS=50
#LR=0.01
...
for step in "${steps[@]}"; do
    # 当前模型对应的目录与文件名
    BASE_DIR="${BASE_ROOT}/Janus-Pro-7B-geneval-geneval-text-text_k${text_k}-steps${STEPS}-lr${lr}-reward_threshold${reward_threshold}"
